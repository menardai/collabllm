...
Example
-------
CUDA_VISIBLE_DEVICES=6 WANDB__SERVICE_WAIT=300 python -m scripts.online_dpo \
...
def main() -> None:
    ...
    # TODO: trick to maintain one vllm for generation and reward computation
    # trainer.args.use_vllm = vllm is not None
    # trainer.llm = vllm
