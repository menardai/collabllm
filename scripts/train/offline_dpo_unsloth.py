...
def load_model_and_tokenizer(
    ...
    # If a 4-bit config is provided, prefer Unsloth's highly optimized 4-bit loader
...
def main() -> None:
    ...
    # Trainer config
    # DeepSpeed can conflict with Unsloth 4-bit LoRA training. Disable when using 4-bit.
    ds_backend = None if args.use_4bit else ds_cfg
